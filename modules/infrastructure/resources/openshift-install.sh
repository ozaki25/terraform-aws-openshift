...
ansible-playbook -i $HOME/inventory.yml /usr/share/ansible/playbooks/prerequisites.yml
ansible-playbook -i $HOME/inventory.yml /usr/share/ansible/playbooks/deploy_cluster.yml
